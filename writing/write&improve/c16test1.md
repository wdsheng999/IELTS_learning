...
>这是题目：The charts below show the changes in ownership of electrical appliances and amount of time spent doing housework in households in one country between 1920 and 2019. Summarize the information by selecting and reporting the main features, and make comparisons where relevant. Write at least 150 words.

>In the comparison between the hours of housework and the percentage of electrical appliances, we can see a big trend of working hours declining with the population of all kinds of domestic appliances. After a century, the number of hours doing housework per week has gone from approximately 50 hours to 10, which means about 40 hours of housework labour is saved, which is often token by women, that is a huge progress of improvement that the development of technology helps to free human labour.
 The we take a closer look into the data of different catagories of household appliances. First is refrigerator, which is invented around 1920 and rapidly accepted by all families for its irreplaceable use of keeping food fresh. Vacuum cleaner is another item that every family keeps at their home at around 2000. But we can see that the washing machine is until now not been owned 100 percent by all families. And it is also the only appliance that had been through a decline in the 1960s, perhaps caused by energy prise and water shortage. And we can tell that from common sense, some of the clothes are not suitable for machine wash, which is another reason.
